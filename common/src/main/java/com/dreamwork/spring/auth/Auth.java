...
import com.dreamwork.spring.db.annotation.ForbidUpdate;
import com.dreamwork.spring.db.annotation.PrimaryKey;
import com.dreamwork.spring.db.annotation.Transient;
...
public class Auth {
	 ...
	 * 权限名称
	 */
	@Pattern(regexp = "^[\u4e00-\u9fa5_a-zA-Z0-9]{2,20}", message = "{auth.name.format.error}")
	 ...
	 * 权限描述
	 */
	@Pattern(regexp = "^[\\u4e00-\\u9fa5_a-zA-Z0-9]{2,50}", message = "{auth.desc.format.error}")
